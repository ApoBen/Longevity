...
function renderEmptyState() {
    return `
        <div class="empty-state-card glass-card">
            ...
            <p>Seçilen tarih için detaylı saatlik dilim verisi bulunamadı. Lütfen ana sayfa üzerinden Samsung Health JSON dosyası import edin veya örnek veri yükleyin.</p>
